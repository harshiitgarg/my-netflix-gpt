...
const MovieCard = ({ movie }) => {
  return (
    <div className="w-44 px-2 rounded-md relative overflow-y-hidden group">
      <Link to={"/watch/" + movie.title}>
        <img
          src={IMG_CDN + movie.poster_path}
          alt="Movie Card"
          className="transition-transform duration-300 ease-in-out rounded-md group-hover:z-10 group-hover:scale-110"
        />
